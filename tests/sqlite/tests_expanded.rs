            ...
            let _sql_forge_validator = || {
                {
                    type __SqlForgeModel = User;
                    {
                        ...
                        let __sql_forge_validator_arg_0 = __sql_forge_section_case_single_0_filter_name_name;
                        let _ = {
                            {
                                #[allow(clippy::all)]
                                {
                                    ...
                                    ::sqlx::__query_with_result::<
                                        ...
                                        _,
                                    >(
                                            "SELECT id, name FROM users WHERE 1=1  AND name LIKE ? ORDER BY id",
                                            query_args,
                                        )
                                        .try_map(|row: sqlx::sqlite::SqliteRow| {
                                            use ::sqlx::Row as _;
